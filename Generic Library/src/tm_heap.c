...
heap->array=createArray(&success);
if(!success)
{
free(heap);
return NULL;
...
int ri,lci,rci,swi,succ,upperBound;
if(success) *success=false;
if(heap==NULL) return NULL;
...
{
int succ,ri,ci,weight,swi,lci,rci,goDown,upperBound;
